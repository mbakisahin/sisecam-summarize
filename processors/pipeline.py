...
class PipelineCoordinator:
    ...
    def _find_and_compare_nearest_neighbors(self, embedding_data, keyword, final_summary):
        """
        ...
        neighbor_summaries = [neighbor['summary'] for neighbor in nearest_neighbors]

        self.summary_comparator.compare_summaries(final_summary, neighbor_summaries)
